...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        //agendaEventos.adicionarEvento(LocalDate.of(2024, Month.JANUARY, 11), "Evento 4", "Atração 4");
        agendaEventos.adicionarEvento(LocalDate.of(2025, Month.JANUARY, 11), "Evento 5", "Atração 5");
